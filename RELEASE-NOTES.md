...
# 798 Theme
* Version: 25.0
* Released On: TBA (initial release: 22nd July 2001 on Piczo)
* [Recent Changes](https://github.com/warrenwoodhouse/bloggertemplates/commits/main/)
* New Features Added: None
* Bugs Reported: None
* Structural Changes: Recreated theme from my original website theme on Piczo.

# Warren Woodhouse Theme
* Version: 23.3
* Released On: 1st January 2026 (initial release: 2nd September 2007)
* [Recent Changes](https://github.com/warrenwoodhouse/bloggertemplates/commits/main/)
* New Features Added: None
...
* Version 1.1
* Released On: 26th December 2025 (initial release: 17th June 2004)
* [Recent Changes](https://github.com/warrenwoodhouse/bloggertemplates/commits/main/)
* New Features Added: None
* Bugs Reported: None
* Structural Changes: None
...
# Will Turner Theme
* Version 1.1
* Released On: 24th December 2025 (initial release: 17th June 2004)
* [Recent Changes](https://github.com/warrenwoodhouse/bloggertemplates/commits/main/)
* New Features Added: None
* Bugs Reported: None
* Structural Changes: Recreated for use on Blogger

# Blogging on a Sunday Morning Theme
* Version 1.1
* Released On: 26th October 2025 (initial release: 7th April 2007)
* [Recent Changes](https://github.com/warrenwoodhouse/bloggertemplates/commits/main/)
* New Features Added: None
* Bugs Reported: None
* Structural Changes: None
...
# Dotty Theme
* Version: 1.0
* Released On: 16th October 2025 (initial release: 15th July 2006)
* [Recent Changes](https://github.com/warrenwoodhouse/bloggertemplates/commits/main/)
* New Features Added: None
* Bugs Reported: None
